...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.495\linewidth}
			\begin{itemize}
				\item TKI: Britta Engelhardt, Kristina Berve
				\item Brain vasculature instilled with \uaf~\cite{Schaad2017} 
			\end{itemize}
		\end{column}
		\begin{column}{0.495\linewidth}
...
\end{tikzpicture}%	
			...
			\only<2>{\animategraphics[autoplay,loop,width=\paperwidth,every=\everyframe]{24}{./images/TKI/TKI_control2_1_65um_al05/frames/video-0}{000}{100}}%
			\only<3>{\animategraphics[autoplay,loop,width=\paperwidth,every=\everyframe]{24}{./images/TKI/TKI_control2_1_65um_al05/frames/video-0}{100}{320}}%
			};%
	\end{tikzpicture}%
\end{frame}
