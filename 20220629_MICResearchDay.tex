...
\tikzset{level 1 concept/.append style={level distance = 35mm,transform shape}}
%\tikzset{level 2 concept/.append style={level distance = 30mm,scale=0.9,transform shape}}
...
concept color=ubRed]
			...
			child [grow=-15] {node[concept] {​Law} }
			child [grow=15] {node[concept] {Business, Economics ​and Social Sciences} }
			child [grow=45] {node[concept] {​Medicine} }
    			child [grow=225] {node[concept] {Vetsuisse} }
    			child [grow=195] {node[concept] {​Humanities} }
    			child [grow=165] {node[concept] {​Human Sciences} }
    			child [grow=135] {node[concept] {​Science} };
	\end{tikzpicture}
\end{frame}
...
concept color=ubRed]
			node[concept] {unibe.ch\ Faculties}
			child[concept color=ubRed!31!white,grow=-45] {node[concept] {​Theology}}
			child[concept color=ubRed!31!white,grow=-15] {node[concept] {​Law} }
			child[concept color=ubRed!31!white,grow=15] {node[concept] {Business, Economics ​and Social Sciences} }
			child[grow=45] {node[concept] {​Medicine}
				child [grow=0] {node[concept] {Theodor Kocher Institute (TKI)}}
				child [grow=-45] {node[concept] {School of Dental Medicine}}
				child [grow=180]   {node[concept] {Institute of Anatomy}}
				child [grow=225] {node[concept] {Universitätsklinik für Orthopädische Chirurgie und Traumatologie}}		
				}
    			child[grow=225] {node[concept] {Vetsuisse} }
    			child[concept color=ubRed!31!white,grow=195] {node[concept] {​Humanities} }
    			child[concept color=ubRed!31!white,grow=165] {node[concept] {​Human Sciences} }
    			child[grow=135] {node[concept] {Science}
				child [grow=0]{ node[concept] {{Institute of Ecology and Evolution}}}
				child [grow=210]{ node[concept] {Space Research \& Planetary Sciences (WP)}}
    }
    			;
\end{tikzpicture}
\end{frame}
