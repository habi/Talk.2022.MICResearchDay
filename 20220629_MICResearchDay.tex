...
\begin{frame}[label=current]
	...
	\only<1>{%
		\begin{tikzpicture}%
            ...
            \tikzset{level 2 concept/.append style={scale=0.95,level distance = 25mm,transform shape}}%		    \path[mindmap,every node/.style={concept,circular drop shadow},concept color=ubRed]%
