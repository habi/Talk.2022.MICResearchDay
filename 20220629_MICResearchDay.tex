...
\end{tikzpicture}%	
			...
			\only<2>{\animategraphics[autoplay,width=\paperwidth,every=\everyframe]{24}{./images/TKI/TKI_control2_1_65um_al05/frames/video-0}{000}{100}}%
			\only<3>{\animategraphics[autoplay,width=\paperwidth,every=\everyframe]{24}{./images/TKI/TKI_control2_1_65um_al05/frames/video-0}{100}{320}}%
			};%
	\end{tikzpicture}%
\end{frame}
