...
\begin{frame}
	\frametitle{Sakrum}
		...
		\only<2>{%
			\animategraphics[autoplay,height=\imheight,every=\everyframe]{24}{./images/Halm/Becken/Sakrum_C/frames/video-0}{000}{101}%
			}%
\end{frame}
...
\end{tikzpicture}%
			...
			\only<2>{\animategraphics[autoplay,loop,width=\paperwidth,every=\everyframe]{24}{./images/ZMK/45/full/image0}{000}{238}}%
			\only<3>{\animategraphics[autoplay,loop,width=\paperwidth,every=\everyframe]{24}{./images/ZMK/45/full-slices/image0}{000}{234}}%
			};%
	\end{tikzpicture}%
\end{frame}
...
\begin{frame}[label=current]
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center) [shift={(0,-25pt)}]{%
			\only<1>{\animategraphics[autoplay,loop,width=\paperwidth,every=\everyframe]{24}{./images/ZMK/45/transparent-slices/image0}{000}{237}}%	
			\only<2>{\animategraphics[autoplay,loop,width=\paperwidth,every=\everyframe]{24}{./images/ZMK/45/transparent-slices-pulpa/image0}{000}{229}}%
			};%
	\end{tikzpicture}%
\end{frame}
