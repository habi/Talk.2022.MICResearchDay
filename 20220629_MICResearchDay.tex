...
%		\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{/media/habi/Fast_SSD/Talks/20220629_MICResearchDay/images/Chondrules Space Yogita/NWA1241_HR2/frames/{{video-0000}}}};
%	\end{scope}
